...
public class Cronometro {
    ...
    private int tiempoDeActividad = 5; // tiempo de actividad en segundos
    private int tiempoDeDescansoCorto = 1; // tiempo de descanso corto en segundos
    private int tiempoDeDescansoLargo = 3; // tiempo de descanso largo en segundos
    private int numeroDeCiclosParaDescansoLargo = 4; //Numero de ciclos que deben pasar para que se ejecute el tiempo largo de espera
    ...
    private int segundosRestantesActuales = tiempoDeActividad;
    private int cantidadDeCiclosActuales = 0;
